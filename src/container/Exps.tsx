...
const ExpList: Array<IExpList> = [
    { 
        name: '(주) 열두달', 
        subtitle: '단체음식을 배송 하는 Fooding의 프론트엔드 개발자로 근무를 하면서 UI개선 및 내부적으로 필요한 Admin Page와 배송기사용 앱을 개발하였습니다. 임금 문제로 인해 현재 구직을 하고 있습니다.',
        date: '2018.10 ~ ', 
        Icon: '',
        stack: ['Angular', 'Rxjs', 'Sass', 'Ionic4', 'React-native', 'Typescript'],
        project: [
            { 
                title: 'Fooding Menu App 개발',
                date: '2019.06 ~ ',
                subtitle: '정기배송 서비스를 이용하는 고객들을 대상으로 메뉴를 안내하는 앱을 개발하고 있습니다. 사용자의 편의성을 위해 네이티브 개발이 필요해서 React Native를 이용해 개발하고 있습니다.', 
                link: '',
                mywork: [
                    '프론트엔드 개발환경 셋팅', 
                    'Mobx를 이용한 스토어관리', 
            ...
            { 
                ...
                subtitle: '외주로 부터 개발된 fooding.io 를 개선하는 작업을 진행하였습니다. 기획의 요청에 따라 사이트 내 정기배송 소개페이지 등 추가 개발도 진행하였습니다. 이와 관련해서 작년에는 간단한 발표도 해보았습니다.', 
    ...
    { 
        name: '(주) 리브햇', 
        subtitle: '(주)투어벨의 개발을 담당하는 자회사인  (주)리브햇의 개발팀 신입으로 투어벨의 모바일 사용자를 위한 모바일 웹 개발을 진행하였습니다.  기존 기획안을 바탕으로 개발하면서 소셜 로그인을 통한 고객의 예약환경 향상을 건의 및 추가하였습니다.',
        ...
        project: [
            { 
                ...
                mywork: [
                    ...
                    '회원가입 및 비밀번호 변경, 마이페이지, 쿠폰 페이지 개발',
