...
export const ExpList: Array<IExpList> = [
  {
    ...
    project: [
      ...
      },
      {
        ...
        description: <div></div>,
        mywork: [
          '사장님들이 폐업시 보장받을수 있는 노란우산 가입을 쉽게 할 수 있도록 도와드리는 서비스를 유지보수 했습니다.',
        ...
        description: (
          <div>
            <p>
              ...
              기여했습니다. 또한 매출 상승을 위해서 계약한 입점사에서 주문 및 배송, 정산 관리를
              편하게 할 수 있도록 필요한 어드민 기능들을 구현하였습니다.
            </p>
          </div>
        ),
        mywork: [
  ...
  },
  {
    ...
    project: [
      ...
      },
      {
        ...
        worker: 1,
        subtitle:
          '회사에서 사용하는 수학문제, 교재, 학습지들을 전부 관리하는 Content Manage Service를 새롭게 만드는 프로젝트를 진행했습니다.',
        // stack: ['React Query', 'React', 'Typescript', 'TailwindCSS', 'Vite', 'React Hook Form'],
        mywork: [
          '새로운 프로젝트와 구 프로젝트간에 Iframe으로 연결하여, 새 프로젝트에서 기존 페이지는 그대로 쓸 수 있으면서 새로운 페이지를 개발해서 교체하는 식으로 작업하고 있습니다.',
