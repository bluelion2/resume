    ...
    project: [
      {
        ...
        date: '2023.04 ~ 진행중',
        worker: 5,
        subtitle: `사장님들이 원하는 물건을 싸고 편리하게 살수 있는 "캐시노트마켓" 서비스를 개발하고 있습니다.`,
        description: (
          <div>
            <p>
        ...
        mywork: [
          ...
          '고객 요청사항이 많았던 신용카드 및 무통장 입금 결제 기능을 개발하였습니다.',
          '입점사에서 하나의 단일 상품에서 여러가지 옵션을 추가해서 판매할수 있는 기능을 개발하였습니다.',
          '이전에 산 상품을 쉽게 살수 있는 "간편주문" 기능을 개발하였습니다.',
          '다양한 사업장의 고객들에게 알맞는 상품 및 이벤트를 노출시키도록 "서비스 개인화"에 기여하고 있습니다.',
          '팀 내 여러가지 서비스 테스트를 진행하기 쉽도록 Hackle, Clarity 등 다양한 기술들을 도입해보고 실험합니다.',
        ],
        // tobeWork: [
        //   '사용자마다 다른 화면을 볼 수 있도록, 컨텐츠 배치를 쉽게 할 수 있는 툴을 만들고자 합니다.',
        //   '사용자가 포스, 테블릿, 웹 등 다양한 환경에서, 또는 단독으로도 쓸 수 있도록 여러 환경에 대응하는 개발을 하고자 합니다.',
        //   '팀 내 생산성을 높일 수 있도록 자주 사용하는 기능을 자동화하여 개선하고자 합니다. Ex) 이벤트 페이지',
        // ],
      },
    ],
  },
