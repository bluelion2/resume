    ...
    project: [
      {
        ...
        mywork: [
          ...
          'Cypress를 도입하여 주요 사용패턴에서 정상동작하는지 주기적으로 확인합니다.',
        ],
      },
      {
        ...
        mywork: [
          ...
          '개인 IPAD를 쓰는 고객들이 많아지면서, IOS지원에 대한 요구사항이 높아졌습니다. 당장 해결할 수 있는 문제는 아니여서 대안으로 실제 사용자들이 앱을 쓰는것처럼 느끼도록 PWA를 추가햇습니다.',
        ],
      },
      {
        ...
        mywork: [
          '기존 프로젝트가 상태관리 라이브러리인 Redux thunk와 Mobx를 두개 쓰고 있었는데, Mobx 하나로 변환, 타입스크립트를 도입해서 리팩토링을 진행했습니다.',
