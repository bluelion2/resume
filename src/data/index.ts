    ...
    project: [
      {
        ...
        mywork: [
          ...
          '안드로이드, IOS 앱 내부에 일부 페이지가 웹뷰로 들어감으로써 기능별 분기처리를 할 수 있는 공통함수와 인증하는 작업을 담당했습니다.',
        ],
      },
      {
        ...
        mywork: [
          '상태관리 라이브러리인 Redux thunk와 Mobx를 두개 쓰고 있었던 것을 Mobx하나만 쓰는것으로, 타입스크립트를 도입해서 리팩토링을 진행했습니다.',
          'IE11부터 모던 브라우저 까지의 서비스 지원하고 있습니다.',
          'AWS S3와 Codepipeline으로 무중단 배포셋팅을 해서, 현재 진행중인 상황을 비 개발자분들에게 보기 쉽도록 공유하였습니다',
...
export const details = {
  ...
  js: [
    ...
    '타입 추론을 이용하는 타입스크립트를 주로 사용하려고 합니다.',
  ],
  react: [
